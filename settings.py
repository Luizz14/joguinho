...
JUNK_RAIN_DURATION = 8000  # Event duration in milliseconds (8 seconds) - HARDER
...
JUNK_RAIN_FOOD_MIN_SPEED = 10  # Much faster than normal - HARDER
JUNK_RAIN_FOOD_MAX_SPEED = 16  # Extremely fast - HARDER
JUNK_RAIN_MAX_HITS = 0  # Perfect dodging required for bonus - HARDER
